...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #--------------------------------------------------------------------------------------------#
		[ 	:welcome_tab, 'Home', root_path, true, true],
		[ 	:posts_tab, 'Posts', posts_path, true, true],
		[	:profile_tab, 'Profile', current_user, true, true],
		[	:edit_tab, 'Edit Profile', edit_user_path(current_user), true, true],
		[	:signout_tab, 'Sign Out', signout_path, true, true],
		[	:reports_tab, 'Reports', reports_path, true, true],
		[	:signin_tab, 'Sign In', signin_path, true, true],
      #--------------------------------------------------------------------------------------------#
      #    TAB NAME      |    DISPLAY TEXT    |    PATH          |    VISIBLE?    |    ENABLED?    #
      #--------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      #----------------------------------------------------------#
		[ 	:pages, :all_actions, root_path, :welcome_tab],
      #----------------------------------------------------------#
      #    CONTROLLER    |    ACTION          |    TAB           #
      #----------------------------------------------------------#
    ]
